...
<body>
	...
	<div class = "d5">
		<div class = "d6">
			...
			<form action = "inwarddeta" method = "post"><button>Inward Deta</button></form><br><br>			<button>Print</button><br><br>
			...
			<button class = "button">Analytical Statistics</button><br><br>
		...
		<div class = "d7">
			...
			<div class ="d9">
				...
				<form action = "updatetransaction" method = "post">
					...
					<input type = "text" name = "truckno" placeholder = "Enter Truck_No">
					<input type = "text" name = "discription" placeholder = "Enter Discription" class = "i1"><br><br>
					<input type = "text" name  ="looding" placeholder = "Enter Loding Place">
					<input type = "text" name = "deleveryDate" placeholder = "Enter DeleveryDate">
					<input type = "text" name = "length" placeholder = "Enter length"  class = "i1"><br><br>
					...
					<input type = "number" name = "totalamount" placeholder = "Enter Total_amount">
					<input type = "number" name = "totaldelevery" placeholder = "Enter Total_delevery"  class = "i1"><br><br>
					<input type = "number" name = "advance" placeholder = "Enter Advance Amount">
					<input type = "text" name = "remark" placeholder = "Enter Remark">
					<input  type = "number" name = "id" placeholder = "Enter Id" class ="i1"><br><br>					
